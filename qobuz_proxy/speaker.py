...
class Speaker:
    ...
    def _on_app_connected(self, tokens: ConnectTokens) -> None:
        ...
        # Upgrade API client to web-player credentials when the Qobuz app connects.
        # The app issues jwt_api scoped to the app_id we advertised (798273057).
        # Per StreamCore32: jwt_api.jwt is used raw as "Authorization: Bearer <jwt>",
        # not decoded. X-User-Auth-Token is only used with password-login tokens.
